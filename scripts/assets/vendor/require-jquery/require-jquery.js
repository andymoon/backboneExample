...
(function ($) {
    ...
    $.support.placeholder = hasAttribute('placeholder', 'input');
    ...
    $.fn.extend({
        placeholder: function () {
            ...
            return this.filter("[placeholder]").each(function (i) {
                ...
                $placeholder.insertAfter($this).on('click', function (event) {
                    $placeholder.text("");
                    $this.focus();
                });
            });
